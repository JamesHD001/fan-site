  ...
  return (
    <main className="dashboard-page">
      ...
      {active && activePlan && <section className="dashboard-section page-container"><div className="dashboard-grid">
        ...
        {card && <article className="dashboard-panel card-panel"><div><span className="eyebrow">DIGITAL CARD</span><h2>Carry your membership.</h2></div><MembershipCard card={card} onPrint={printMembershipCard} /></article>}
      </div></section>}
