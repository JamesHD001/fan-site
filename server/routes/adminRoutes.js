...
const {
  ...
  listGifts, createGift, updateGift: updateCatalogGift, deleteGift,
...
router.get("/gift-transactions", getGiftTransactions);
router.patch("/gift-transactions/:id/status", updateGiftStatus);
router.get("/membership-plans", getMembershipPlansAdmin);
router.patch("/membership-plans/:id", updateMembershipPlan);
router.get("/meeting-types", getMeetingTypesAdmin);
router.patch("/meeting-types/:id", updateMeetingType);
router.get("/catalog/plans", listPlans);
router.post("/catalog/plans", createPlan);
router.patch("/catalog/plans/:id", updatePlan);
router.delete("/catalog/plans/:id", deletePlan);
router.get("/catalog/meetings", listMeetings);
router.post("/catalog/meetings", createMeeting);
router.patch("/catalog/meetings/:id", updateMeeting);
router.delete("/catalog/meetings/:id", deleteMeeting);
router.get("/catalog/gifts", listGifts);
router.post("/catalog/gifts", createGift);
router.patch("/catalog/gifts/:id", updateCatalogGift);
router.delete("/catalog/gifts/:id", deleteGift);
