...
const cryptoOptionSchema=new mongoose.Schema({currency:{type:String,required:true,uppercase:true,trim:true},network:{type:String,required:true,trim:true},walletAddress:{type:String,required:true,trim:true},qrCode:{type:String,default:"",trim:true},isActive:{type:Boolean,default:true}},{_id:true});
